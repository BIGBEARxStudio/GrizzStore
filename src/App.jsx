...
// App.jsx now re-exports the working app component from AppNew to avoid confusion from older corrupted content.
// App entrypoint
// Re-export the working application from AppNew to avoid keeping corrupted legacy content here.
    ...
    <BrowserRouter>
      <header className="gb-header">
        <div className="gb-container">
          ...
          <button className={`mobile-menu-toggle ${isNavOpen ? 'open' : ''}`} onClick={() => setIsNavOpen(v => !v)} aria-label="Toggle navigation">
            <span />
            <span />
            <span />
          </button>

          <motion.nav className={`gb-nav ${isNavOpen ? 'active' : ''}`} initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
            <NavLink to="/" onClick={() => setIsNavOpen(false)}>
              <Icons.Home />
              <span>Home</span>
            </NavLink>
            <NavLink to="/products" onClick={() => setIsNavOpen(false)}>
              <Icons.Shop />
              <span>Merch</span>
            </NavLink>
            <NavLink to="/sublimation" onClick={() => setIsNavOpen(false)}>
              <Icons.Print />
              <span>Sublimation</span>
            </NavLink>
            ...
            <NavLink to="/auth" onClick={() => setIsNavOpen(false)}>
              <Icons.User />
              <span>Sign In</span>
            </NavLink>
            <NavLink to="/admin" onClick={() => setIsNavOpen(false)}>
              <Icons.Admin />
              <span>Admin</span>
            </NavLink>
          </motion.nav>
